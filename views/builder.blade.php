        ...
        <div class="section-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="drdCommandType" class="form-control" style="width: 100%">
                                        <option value="crud:api_scaffold">API Scaffold Generator</option>
                                        <option value="crud:api">API Generator</option>
                                        <option value="crud:scaffold">Scaffold Generator</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-8">
                                    <label for="txtModelName" class="ml-3 mb-3 font-weight-bold">Options</label>
                                    <div class="form-inline form-group ml-3" style="border-color: transparent">
                                ...
                                <div class="form-inline col-md-12" style="padding-top: 10px">
                                    <div class="form-group chk-align" style="border-color: transparent;">
                                        <button type="button" class="btn btn-primary btn-flat btn-green" id="btnAdd">
                                            Add Field
                                        </button>
                                    </div>
                                    <div class="form-group chk-align" style="border-color: transparent;">
                                        <button type="button" class="btn btn-primary btn-flat" id="btnPrimary"> Add
                                            Primary
                                        </button>
                                    </div>
                                    <div class="form-group chk-align" style="border-color: transparent;">
                                        <button type="button" class="btn btn-primary btn-flat" id="btnTimeStamps"> Add
                                            Timestamps
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="form-inline col-md-12" style="padding-top: 10px">
                                    <div class="form-group" style="border-color: transparent;">
                                        <button type="button" class="btn btn-primary btn-flat" id="btnRelationShip"> Add
                                            RelationShip
                                        </button>
                                    </div>
                                </div>

                                <div class="form-inline col-md-12 d-flex justify-content-end"
                                     style="padding:15px 15px;text-align: right">
                                    <div class="form-group" style="border-color: transparent;padding-left: 10px">
                                        <button type="submit" class="btn btn-flat btn-primary" id="btnGenerate">Generate
                                        </button>
                                    </div>
                                    <div class="form-group" style="border-color: transparent;padding-left: 10px">
                                        <button type="button" class="btn btn-light btn-flat" id="btnReset"
                                                data-toggle="modal"
            ...
            <div class="card card-primary">
                ...
                <div class="card-header" style="margin-top: 10px">
                    <h1 class="card-title" style="font-size: 30px">Rollback</h1>
                </div>
                <div class="card-body">
                    <form id="rollbackForm">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="txtRBModelName" class="form-control">
                            ...
                            <div class="form-inline col-md-12" style="padding:15px 15px;text-align: right">
                                <div class="form-group" style="border-color: transparent;padding-left: 10px">
                                    <button type="submit" class="btn btn-flat btn-primary btn-blue" id="btnRollback">
                                        Rollback
                                    </button>
                                </div>
                            </div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-header" style="margin-top: 10px">
                    <h1 class="card-title" style="font-size: 30px">Generate CRUD From Schema</h1>
                </div>
                <div class="card-body">
                    <form method="post" id="schemaForm" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-inline col-md-12" style="padding:15px 15px;text-align: right">
                                <div class="form-group" style="border-color: transparent;padding-left: 10px">
                                    <button type="submit" class="btn btn-flat btn-primary btn-blue" id="btnSmGenerate">
                                        Generate
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $(document).ready(function () {
                ...
                $('#form').on('submit', function (e) {
                    ...
                    $('.item').each(function () {
                        ...
                        var validationType = $(this).find('.drdValidation');
                        var htmlValue = '';
                        var validationValue = '';
                        ...
                        var validationArr = $(this).find('.drdValidation').val();
                        if (validationArr != null) {
                            validationValue = validationArr.join();
                        }
                        fieldArr.push({
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            var $scrollTo = $('#info');
                            $container.animate(
                                { scrollTop: $scrollTo.offset().top - $container.offset().top, scrollLeft: 0 }, 300);
                            setTimeout(function () {
                                $('#info').fadeOut('fast');
                            }, 3000);
                            location.reload();
            ...
            function initializeCheckbox (el) {
                ...
                $(el).find('select').select2({ width: '100%', tags: true });
