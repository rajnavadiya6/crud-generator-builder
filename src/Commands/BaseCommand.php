...
namespace Crud\GeneratorBuilder\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Str;
use Crud\GeneratorBuilder\Common\CommandData;
use Crud\GeneratorBuilder\Generators\API\APIControllerGenerator;
use Crud\GeneratorBuilder\Generators\API\APIRequestGenerator;
use Crud\GeneratorBuilder\Generators\API\APIRoutesGenerator;
use Crud\GeneratorBuilder\Generators\API\APITestGenerator;
use Crud\GeneratorBuilder\Generators\FactoryGenerator;
use Crud\GeneratorBuilder\Generators\MigrationGenerator;
use Crud\GeneratorBuilder\Generators\ModelGenerator;
use Crud\GeneratorBuilder\Generators\RepositoryGenerator;
use Crud\GeneratorBuilder\Generators\RepositoryTestGenerator;
use Crud\GeneratorBuilder\Generators\Scaffold\ControllerGenerator;
use Crud\GeneratorBuilder\Generators\Scaffold\MenuGenerator;
use Crud\GeneratorBuilder\Generators\Scaffold\RequestGenerator;
use Crud\GeneratorBuilder\Generators\Scaffold\RoutesGenerator;
use Crud\GeneratorBuilder\Generators\Scaffold\ViewGenerator;
use Crud\GeneratorBuilder\Generators\SeederGenerator;
...
class BaseCommand extends Command
{
    ...
    {
        $migrationPath = config('crud.generator_builder.path.migration', database_path('migrations/'));
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('crud.generator_builder.path.schema_files', resource_path('model_schemas/'));
    ...
    private function saveLocaleFile()
    {
        ...
        $path = config('crud.generator_builder.path.models_locale_files', base_path('resources/lang/en/models/'));
    ...
    public function getOptions()
    {
        return [
            ...
            [
                'views', null, InputOption::VALUE_REQUIRED,
