...
class RequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('scaffold.request.create_request', 'generator-builder');
    ...
    private function generateUpdateRequest()
    {
        ...
        $templateData = get_template('scaffold.request.update_request', 'generator-builder');
