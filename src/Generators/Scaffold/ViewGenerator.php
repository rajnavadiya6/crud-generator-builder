...
use Crud\GeneratorBuilder\Generators\ViewServiceProviderGenerator;
use Crud\GeneratorBuilder\Utils\FileUtil;
use Crud\GeneratorBuilder\Utils\HTMLFieldGenerator;
...
class ViewGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->templateType = config('crud.generator_builder.templates', 'generator-builder');
    }
    ...
    {
        if ($this->commandData->getAddOn('datatables')) {
            $templateName = 'datatable_show_field';
        } else {
