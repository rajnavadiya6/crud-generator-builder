...
namespace Crud\GeneratorBuilder\Controllers;
...
use Crud\GeneratorBuilder\Requests\BuilderGenerateRequest;
use Request;
use Response;
...
class GeneratorBuilderController extends Controller
{
    ...
    {
        return view(config('crud.generator_builder.views.field-template'));
    }
...
//    {
//        $schemaFolder = config('crud.generator_builder.path.schema_files', base_path('resources/model_schemas/'));
//
