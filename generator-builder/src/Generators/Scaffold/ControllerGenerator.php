...
class ControllerGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->templateType = config('crud.generator_builder.templates', 'stisla-templates');
    ...
    public function generate()
    {
        if ($this->commandData->getAddOn('datatables')) {
            ...
            $templateData = get_template("scaffold.controller.$templateName", 'generator-builder');
    ...
    private function generateDataTable()
    {
        ...
        $templateData = get_template('scaffold.'.$templateName, 'generator-builder');
